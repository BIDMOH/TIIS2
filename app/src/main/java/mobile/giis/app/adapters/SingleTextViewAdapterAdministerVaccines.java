 ...
 */
public class SingleTextViewAdapterAdministerVaccines extends ArrayAdapter<String> {
    List<String> items;
    Activity act;

    public SingleTextViewAdapterAdministerVaccines(Activity context, int resource, List<String> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        View rowView = convertView;
        LayoutInflater vi = (LayoutInflater) act.getApplicationContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        rowView = vi.inflate(R.layout.single_text_spinner_vaccine_lot, null);
