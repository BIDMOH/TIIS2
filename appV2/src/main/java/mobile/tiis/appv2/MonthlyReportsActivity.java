...
import mobile.tiis.appv2.adapters.SpinnerAdapter;
import mobile.tiis.appv2.base.BackboneApplication;
import mobile.tiis.appv2.database.DatabaseHandler;
import mobile.tiis.appv2.database.GIISContract;
import mobile.tiis.appv2.database.SQLHandler;
import mobile.tiis.appv2.entity.MonthEntity;

import java.util.Calendar;

import static mobile.tiis.appv2.util.Constants.ADS_O5ML;
import static mobile.tiis.appv2.util.Constants.ADS_OO5ML;
import static mobile.tiis.appv2.util.Constants.SAFETY_BOXES;
import static mobile.tiis.appv2.util.Constants.SDILLUTION;
import static mobile.tiis.appv2.util.Constants.VITAMIN_A_100000_IU;
