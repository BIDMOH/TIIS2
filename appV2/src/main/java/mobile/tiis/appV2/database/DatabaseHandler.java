...
import static mobile.tiis.appv2.util.DatabaseUtil.FOLDER_EXTERNAL_DIRECTORY;
...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        Log.w(TAG, "Not recreating the database since we are using an imported one");
    }
    ...
    public List<User> getAllUsers() {
        ...
        //Query on Child Table
        String selectQuery = "SELECT  * FROM " + Tables.USER +" ORDER BY "+BaseColumns._ID+" DESC";
