...
//                                    e.printStackTrace();
//                                }
//                                DatabaseHandler db = staging.getDatabaseInstance();
//                                // check if child is in DB , if not than get child data from server
//                                if (!db.isChildInDB(barcode)) {
//                                    staging.updateVaccinationQueue(barcode, staging.getLOGGED_IN_USER_HF_ID(), dateNow, staging.getLOGGED_IN_USER_ID());
//
//                                    staging.registerAudit(BackboneApplication.CHILD_AUDIT, barcode, dateNow, staging.getLOGGED_IN_USER_ID(), BackboneApplication.ACTION_CHECKIN);
//
//                                    int parseResult = staging.parseChildCollectorSearchByBarcode(barcode);
//                                    if (parseResult == 2) {
...
//                                    }
//
//                                    parseHFIDWhenNotInDb(db, staging);
//
//
//                                }
//                                // this should never be null in this part of the staging according to the lines of code above
...
//                    thread.start();
//
//                    //Do the backgroud staging logic
//                    break;
