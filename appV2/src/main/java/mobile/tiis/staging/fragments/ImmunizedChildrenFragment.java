...
import mobile.tiis.staging.adapters.ImmunizationsListAdapter;
import mobile.tiis.staging.adapters.ImmunizedChildrenListAdapter;
import mobile.tiis.staging.base.BackboneApplication;
import mobile.tiis.staging.database.DatabaseHandler;
import mobile.tiis.staging.entity.ChartDataModel;
import mobile.tiis.staging.entity.ModelImmunizedChild;
import mobile.tiis.staging.entity.NewChartDataTable;
...
//        List<ChartDataModel> listItems = mydb.getMonthlyPerformance(staging);
...
//        }
//
//        BarDataSet set1 = new BarDataSet(noVals, staging.getString(R.string.no_of_children_immunized));
//        // set1.setColors(ColorTemplate.createColors(getApplicationContext(),
//        // ColorTemplate.FRESH_COLORS));
//        set1.setColor(Color.rgb(109, 164, 213));
//        BarDataSet set2 = new BarDataSet(cummNoVals, staging.getString(R.string.cumm_no_children_immunized));
