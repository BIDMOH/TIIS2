...
import mobile.tiis.staging.adapters.DrawerListItemsAdapter;
...
public class HomeActivityRevised extends BackboneActivity {
    ...
    public final String[] mFragments = {
            "mobile.tiis.staging.fragments.HomeFragment",
            "mobile.tiis.staging.fragments.HomeFragment",
            "mobile.tiis.staging.fragments.RegisterChildFragment",
            "mobile.tiis.staging.fragments.SearchChildFragment",
            "mobile.tiis.staging.fragments.VaccinationQueueFragment",
            "mobile.tiis.staging.fragments.ReportsFragment",
            "mobile.tiis.staging.fragments.MonthlyPlanFragment",
            "mobile.tiis.staging.fragments.StockFragment",
            "mobile.tiis.staging.fragments.RegisterChildFragment"
    };

    public final String HOME_FRAGMENT = "mobile.tiis.staging.fragments.HomeFragment";
    public final String REGISTER_CHILD_FRAGMENT = "mobile.tiis.staging.fragments.RegisterChildFragment";
    public final String SEARCH_CHILD_FRAGMENT = "mobile.tiis.staging.fragments.SearchChildFragment";
    public final String VACCINATION_QUEUE_FRAGMENT = "mobile.tiis.staging.fragments.VaccinationQueueFragment";
    public final String REPORTS_FRAGMENT = "mobile.tiis.staging.fragments.ReportsFragment";
    public final String MONTHLY_PLAN_FRAGMENT = "mobile.tiis.staging.fragments.MonthlyPlanFragment";
    public final String SETTINGS_FRAGMENT = "mobile.tiis.staging.fragments.SettingsFragment";
    public final String STOCK_FRAGMENT = "mobile.tiis.staging.fragments.StockFragment";
...
//                wifi_logo.setBackgroundColor(0xffff0000);
    ...
    public void changeFragment(String fragment, String title){
        ...
        //staging.setCurrentFragment("HOME");
     ...
     * <p/>
     * If result is empty, the staging needs to register.
     *
