...
import mobile.tiis.staging.entity.AefiListItem;
...
import mobile.tiis.staging.entity.ImmunizationCardItem;
...
import mobile.tiis.staging.entity.VaccinationQueueObject;
...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        // TODO function affects the case where the device will hav a DB preinstalled before even installing the staging
        if (!dbPreinstalled) {
...
// " AND v."+SQLHandler.VaccinationEventColumns.HEALTH_FACILITY_ID+" = '"+staging.getLOGGED_IN_USER_HF_ID()+"'"+
        SQLiteDatabase db = this.getWritableDatabase();
        Cursor cursor = db.rawQuery(selectQuery, null);
