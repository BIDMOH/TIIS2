...
import mobile.tiis.staging.GCMCommunication.ServerUtilities;
...
import mobile.tiis.staging.util.ExpandedListView;
...
public class LoginActivity extends BackboneActivity implements View.OnClickListener {
    ...
    private String getRegistrationId(Context context) {
        ...
        // Check if staging was updated; if so, it must clear the registration ID
        ...
        new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... params) {
                ...
                try {
                    ...
                    // so it can use GCM/HTTP or CCS to send messages to your staging.
                    // The request to your server should be authenticated if your staging
                    // is using accounts.
//                    sendRegistrationIdToBackend();
    ...
    private void sendRegistrationIdToBackend() {
        ...
        mRegisterTask = new AsyncTask<Void, Void, Void>() {
            ...
            protected void onPostExecute(Void result) {
                mRegisterTask = null;
                Log.d(TAG, "The staging has been registered on ADR Hakiki dawa Server");
            }
        };
    ...
    /**
     * Stores the registration ID and staging versionCode in the application's
    ...
    private void storeRegistrationId(Context context, String regId) {
        ...
        Log.d(TAG, "Saving regId on staging version " + appVersion);
    ...
    protected void onCreate(Bundle starter) {
        ...
        if (checkPlayServices()) {
            ...
            if (isInternetAvailable()) {
                /**
                 * registering the staging to Google Cloud Messaging
                 */
...
//        getActionBar().setBackgroundDrawable(new ColorDrawable(this.getResources().getColor(R.color.light_blue_600)));
        ...
        app.LAST_FRAGMENT = "mobile.tiis.staging.fragments.HomeFragment";
